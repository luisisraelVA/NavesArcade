...
{
    // --- Naves ---
    const TCHAR* const MallaNaveJugador = TEXT("SkeletalMesh'/Game/MallasFinales/9d06199c2def4d1b95bc7e37e8f30cf1_fbx.9d06199c2def4d1b95bc7e37e8f30cf1_fbx'");
    ...
    const TCHAR* const MallaAsteroideExplosivo = TEXT("StaticMesh'/Engine/BasicShapes/Cube.Cube'");
    const TCHAR* const MallaAsteroideFractal = TEXT("StaticMesh'/Engine/BasicShapes/Cube.Cube'");
    const TCHAR* const MallaNucleoEnergia = TEXT("StaticMesh'/Game/MallasFinales/Energy_Canister.Energy_Canister'");
    const TCHAR* const MallaPortalSuperficie = TEXT("StaticMesh'/Game/MallasFinales/Portal_PortalSurface_low.Portal_PortalSurface_low'");


    // --- Efectos ---
    const TCHAR* const EfectoExplosion = TEXT("ParticleSystem'/Game/StarterContent/Particles/P_Explosion.P_Explosion'");
}